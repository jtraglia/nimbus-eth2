...
proc fetchDepositSnapshot(client: RestClientRef):
  ...
  let resp = try:
    awaitWithTimeout(client.getDepositSnapshot(), smallRequestsTimeout):
      return err "Fetching /eth/v0/beacon/deposit_snapshot timed out"
  except CatchableError as e:
    return err("The trusted node likely does not support the /eth/v0/beacon/deposit_snapshot end-point:" & e.msg)
